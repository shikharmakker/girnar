...
if(count($_POST)>0) {
	$check="select * from users where username = '$_POST[user_name]' and password = '$_POST[password]'";
    ...
    <div class="module">
        ...
        <form   method="post" enctype="multipart/form-data" autocomplete="off" onsubmit="return Verify()" name="myform">
            ...
            <table style="width: 100%">
            	<tr align="center">
            		<td>
            <input type="text" placeholder="User Name" name="user_name" style="width: 350px;background-color:rgba(0, 0, 0, .2);color:black" required /><br>
